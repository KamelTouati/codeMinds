...
const Card = ({ name, description }:any) => {
  return (
    ...
    >
      ...
      <div className="p-5">
        <a href="#">
          <h5 className="mb-2 text-2xl font-bold tracking-tight text-color7">
            {name}
          </h5>
        </a>
    ...
    <>
      ...
      <div className="relative">
        ...
        <div className="px-5 md:px-20 my-10 relative">
          ...
          <h4
            data-aos="slide-up"
            className="leading-10 font-semibold text-[#68769F] my-5"
          >
        ...
        <div className="px-5 lg:py-10 md:px-20 my-10 relative bg-color3 flex items-content flex-col">
          ...
          <h1
            data-aos="slide-up"
            className="font-semibold text-5xl text-white text-sm my-5 text-center"
          >
